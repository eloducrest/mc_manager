...
export const headers: Header[] = [
  ...
  {text: "Emplacement", value: "location.code"},
...
export const table_actions = [
  {
    ...
    method: (costume: CostumeInterface) => {
      ...
      useHandleModalsStore().toggleModalCostume();
      useCostumestore().isUpdate = true;
    },
  ...
  },
  {
    ...
    method: (costume: CostumeInterface) => {
      router.get(route('costumes.view', {id: costume.id}))
    },
  ...
  },
  {
    ...
    method: (costume: CostumeInterface) => {
      useCostumestore().selectedCostume = costume;
      useHandleModalsStore().toggleModalCostumeAssignCostumeToActor();
    },
