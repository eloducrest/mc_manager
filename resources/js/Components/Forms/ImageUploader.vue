...
<template>
  <div class="relative z-30 mx-auto w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:max-w-44 sm:p-3">
    <div class="relative drop-shadow-2 min-h-25">
      <img :src="previewImage ?? '/image/empty.jpg'"
           @click="selectImage"
           class="w-full"
           alt="">

      <label for="costume_img" @click="selectImage"
