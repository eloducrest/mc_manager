...
const searchClient = algoliasearch(
  usePage().props.scoutID,
  usePage().props.scoutSecret
)
</script>
        ...
        <form action="https://formbold.com/s/unique_form_id" method="POST">
          <div class="relative">
            ...
            <!--<ais-instant-search :search-client="searchClient" index-name="users">
              <ais-search-box placeholder="Type to search..."></ais-search-box>
              <ais-hits>
                <template v-slot:item="{ item }">
                  <Link href="/users">{{ item.email }}</Link>
                </template>
              </ais-hits>
            </ais-instant-search>-->
            <input
              ...
              class="w-full xl:w-125 bg-transparent pr-4 pl-9 focus:outline-none border-none focus:border-transparent focus:shadow-transparent"/>
          </div>
        </form>
      </div>
