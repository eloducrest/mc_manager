...
<template>
  <li>
    <Link :href="item.route"
          class="group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-boxdark"
          @click.prevent="handleItemClick"
          :class="{ 'bg-[hsla(0,0%,78%,.2)]': route().current(props.item.name+'*') }">
